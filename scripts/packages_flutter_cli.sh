#!/usr/bin/bash
# See https://github.com/brianegan/flutter_architecture_samples/edit/master/scripts/ci.sh
# Ported across to help run flutter pub get in the local subfolder packages
